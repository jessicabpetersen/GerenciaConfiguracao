                    ...
                    <form action="adicionarCliente.php" method="post">	
                        <div class="row">
                            ...
                            <div class="form-group col-md-5">	      
                                ...
                                <input type="number" class="form-control cpf" name="cliente['cpf']" id="inputCPF" maxlength="11" required  placeholder="000.000.000-00" onchange="valida_cpf(this.value)">	    
                            </div>	
                        </div>
                        <div class="row">
                            <div class="form-group col-md-4">	      
                                <label for="name">CEP</label>	      
                                <input type="number" class="form-control cep" name="cliente['cep']" id="inputCEP" placeholder="00000-000" maxlength="8" required onblur="addPontosCEP(this.value)">
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-2">	      
                                ...
                                <input type="number" class="form-control number" name="cliente['numero']" required>	    
                            </div>
                        </div>
