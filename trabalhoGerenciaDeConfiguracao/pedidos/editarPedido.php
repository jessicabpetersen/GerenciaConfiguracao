                                        ...
                                        <?php if ($pedido_produtos) : ?>	
                                            ...
                                            <tr id="<?php echo $linha ?>">
                                                <td><input type="text" class="form-control" id="<?php echo $idproduto ?>" name="<?php echo  $idproduto ?>" value="<?php echo $produtoAtual['id']; ?>" disabled="" ></td>
                                                    ...
                                                    <td><input type="text" class="form-control" id="<?php echo  $precoed?>" name="<?php echo  $preco?>" value="<?php echo $produto_pedido['preco']; ?>" onchange="EditarValorTotal(<?php echo count($pedido_produtos) ?>)"></td>
                                                    ...
                                                    <td><input type="text" class="form-control" id="<?php echo  $descontoed?>" name="<?php echo  $desconto?>" value="<?php echo $produto_pedido['desconto']; ?>" onchange="EditarValorTotal(<?php echo count($pedido_produtos) ?>)"></td>
